                ...
                <div class="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
                    ...
                    <div class="space-y-3">
                        @foreach($categories as $category)
                            <a href="{{ route('blog.category', $category->category->name) }}" class="flex items-center justify-between px-4 py-3 rounded-xl hover:bg-primary/5 text-gray-700 hover:text-primary transition group">
