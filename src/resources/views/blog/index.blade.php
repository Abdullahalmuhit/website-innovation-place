                            ...
                            <div class="md:w-2/5 relative overflow-hidden h-64 md:h-auto">
                                ...
                                @else
                                    ...
                                    <div class="absolute inset-0 flex items-center justify-center">
                                        <i class="fas fa-{{ $blog->category == 'Technology' ? 'microchip' : ($blog->category == 'Development' ? 'code' : 'paint-brush') }} text-8xl text-white opacity-30 group-hover:scale-110 transition-transform duration-500"></i>
                                    </div>
                                @endif
                                <!-- Category Badge on Image -->
                                <div class="absolute top-4 left-4 z-10">
                                    <a href="{{ route('blog.category', $blog->category) }}" class="bg-white/90 backdrop-blur-sm text-primary px-4 py-2 rounded-full text-sm font-bold hover:bg-white transition shadow-lg">
                                        {{ $blog->category }}
                                    </a>
                                </div>
                            </div>
                ...
                <div class="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
                    ...
                    <div class="space-y-3">
                        @foreach($categories as $category)
                            <a href="{{ route('blog.category', $category) }}" class="flex items-center justify-between px-4 py-3 rounded-xl hover:bg-primary/5 text-gray-700 hover:text-primary transition group">
                ...
                <div class="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
                    ...
                    <div class="space-y-5">
                        @foreach($blogs->take(5) as $recent)
                            <a href="{{ route('blog.show', $recent) }}" class="block group">
        ...
        <div class="lg:col-span-2 space-y-12">
            @forelse($blogs as $blog)
                <article class="group bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                    <div class="md:flex">
                        <!-- Image Section -->
                        <div class="md:w-2/5 relative overflow-hidden bg-gradient-to-br from-blue-400 via-purple-500 to-pink-500 h-64 md:h-auto">
                            <div class="absolute inset-0 flex items-center justify-center">
                                <i class="fas fa-{{ $blog->category == 'Technology' ? 'microchip' : ($blog->category == 'Development' ? 'code' : 'paint-brush') }} text-8xl text-white opacity-30 group-hover:scale-110 transition-transform duration-500"></i>
                            </div>
                            <!-- Category Badge on Image -->
            ...
            <div class="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
                ...
                <div class="space-y-5">
                    @foreach($blogs->take(5) as $recent)
                        <a href="{{ route('blog.show', $recent) }}" class="block group">
                            <div class="flex space-x-4">
                                <div class="flex-shrink-0 w-16 h-16 bg-gradient-to-br from-primary to-purple-600 rounded-lg flex items-center justify-center">
                                    <i class="fas fa-newspaper text-white text-xl"></i>
                                </div>
                                <div class="flex-1 min-w-0">
                                    <h4 class="font-semibold text-gray-900 group-hover:text-primary mb-1 line-clamp-2 transition">
