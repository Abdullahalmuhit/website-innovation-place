...
@section('content')
    <div class="max-w-4xl">
        <form action="{{ route('admin.blog.update', $post->id) }}" method="POST" class="bg-white rounded-xl shadow-lg p-8" enctype="multipart/form-data">
            @csrf
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="excerpt" rows="3" required maxlength="500"
                              class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent">{{ $post->excerpt }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="content" rows="15" required
                              class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent font-mono text-sm">{{ $post->content }}</textarea>
